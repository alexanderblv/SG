...
const privyConfig = {
  ...
  externalWallets: {
    ...
    walletConnect: true,
    rainbow: true,
    // ⚠️ БЕЗОПАСНОСТЬ: Отключаем Rabby из-за проблем с поддельными версиями
    // Поддельные версии Rabby показывают подозрительные диалоги авторизации
    // с прокси-серверами, что пугает пользователей и создает риски безопасности
    rabby: false,
  },
